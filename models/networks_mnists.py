...
class tmil(nn.Module):
    def __init__(self, args):
        ...
        self.decoder_x= decoder_x(latent_dim=self.instance_latent_dim, hidden_dims=None, in_channels=3)
        self.encoder_x = encoder_x(latent_dim=self.instance_latent_dim, hidden_dims=None, in_channels=3)
